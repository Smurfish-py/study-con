...
try {
    ...
    if($stmt->rowCount() > 0){
        ...
        if ($user['tipe_akun'] == 'google') {
            header("location: multifunction_page/error.php?message=Email%20terhubung%20melalui%20metode%20lain%2E&link=login%2Ephp&type=Login%20page");
        } else {
