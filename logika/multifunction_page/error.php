...
<body class="center-page" style="height: 100vh;">
    <div class="inter-300" style="background-color: white; width: 500px; height: 400px; border: solid 1px; border-color: #bebebe;">
        <div class="upper-side" style="background-color: #E25555; padding: 20px 30px; color: white; font-size: 50px;">
            <p style="margin-top: 0; margin-bottom: 0;">Something<br>went wrong :(</p>
        </div>
