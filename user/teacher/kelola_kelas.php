...
<header class="inter-400 header-dark" style="display: flex; justify-content: space-between; padding: 0 50px; align-items: center;">
    ...
    <main style="border: solid; height: 99vh; display: flex; align-items: center; justify-content: center;">
        <div class="kelola-kelas-container">
            <div class="kelola-kelas-header">
                <div class="kelola-kelas-title">
                    <h1 class="inter-500 font-size-header">Kelas Anda <br><span class="inter-400 font-size-l">(Klik kelas untuk mengelola kelas tersebut)</span></h1>
                    <a href="index.php" class="inter-400" style="text-decoration: none; color: black;">Kembali ke dashboard</a>
                </div>
                <hr>
            </div>
            <div class="kelola-kelas-body">
                <?php
                ...
                while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                    ?>
                    <a href="kelola.php?id=<?php echo $row['id']?>" class="kelola-kelas-list" style="background-image: url('../../assets/images/kelas/<?php
                    ...
                    ?>');">
                    <div class="kelola-kelas-list-body">
                        <h2 class="inter-500 font-size-xl" style="position: absolute;color: white; margin-left: 15px;"><?php echo $row['nama_kelas']?><br><span class="inter-400 font-size-l">ID Kelas: <?php echo $row['id']?></span></h2>
                    </div>
                    </a>
                    <hr style="margin: 3px;">
                    <?php
