    ...
    <main class="inter-400">
        <div class="buat-kelas-container">
            ...
            <div class="form-side" style="display: flex;justify-content: center; align-items: center; height: 80vh; flex: 1;">
                <form action="" method="post" style="display: flex; gap: 10px; flex-direction: column;">
                    <div>
                        <label class="inter-600" for="">Nama kelas</label><br>
                        <input class="inter-400 input-kelas" type="text" name="" id="" placeholder="Masukkan nama kelas anda..."> 
                    </div>
                    <div>
                        <label class="inter-600" for="">Password (Opsional)</label><br>
                        <input class="inter-400 input-kelas" type="text" name="" id="" placeholder="Masukkan password untuk kelas anda..."> 
                    </div>
                    <div>
                       <label class="inter-600" for="">Keterangan kelas</label><br>
                       <textarea class="inter-400" name="" id="" placeholder="Masukkan deskripsi untuk kelas anda.." style="width: 521px; height: 150px;"></textarea>
                    </div>
                    <div>
